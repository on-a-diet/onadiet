...
corpora and tagged v0.3.x on GitHub, with v0.4 engine-hardening done. **Not yet published to npm** — that's
...
Canonical handbook: <https://github.com/sharvilk/meta-standards> — read
[PRINCIPLES](https://github.com/sharvilk/meta-standards/blob/main/PRINCIPLES.md) +
[CONVENTIONS](https://github.com/sharvilk/meta-standards/blob/main/CONVENTIONS.md) +
[ENGINEERING-STANDARDS](https://github.com/sharvilk/meta-standards/blob/main/ENGINEERING-STANDARDS.md).
...
- **Docs** numbered in `docs/` (`00`–`02` product/plan, `03+` specs, `99-ROADMAP`); research under
  `docs/research/`; every doc has a TOC; **keep `docs/99-ROADMAP.md` current after every meaningful change**.
...
- **Orchestrate & measure, never fake the win.** The engine drives best-in-class local encoders
  (sharp/libvips, qpdf, oxipng, svgo) and **verifies** the output; it never reports a saving it didn't
