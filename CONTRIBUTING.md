...
Thanks for helping put files on a diet. This repo follows the
[engineering handbook](https://github.com/sharvilk/meta-standards) — the short version is below.
...
docs/              PRD, north-star, CLI/usage/messaging/performance specs, roadmap, research.
```
