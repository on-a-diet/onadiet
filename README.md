...
- Not a new codec — v1 orchestrates proven engines (sharp/libvips, qpdf, oxipng, svgo); a permissive
  in-house PDF image-downsampler is the one piece of real engineering (see the PRD).
