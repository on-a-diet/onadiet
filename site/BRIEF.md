...
> The design input for the public site (per [meta-standards/SITE.md](https://github.com/sharvilk/meta-standards/blob/main/SITE.md)).
...
## Non-negotiables (from SITE.md — the look is free, these bars are not)
...
- **Honest copy** — a truthful **`pre-release`** badge (built + tagged v0.3.x, **not on npm yet**); every perf
